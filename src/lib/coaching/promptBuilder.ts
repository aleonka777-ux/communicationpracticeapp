...
export function buildEvaluationSystemPrompt(tool: CommunicationToolRow): string {
  ...
  const sections = [
    ...
    "You have only been given a text transcript of what was said — no audio, and no measurements of tone, pace, pauses, timing, volume, or any other vocal quality. Never claim to have heard, observed, sensed, or measured the person's tone of voice, pace, pauses, hesitation, confidence, nervousness, calmness, emotion, demeanor, or any other paralinguistic or vocal signal — this applies equally to praise and to criticism, so a flattering vocal claim is just as forbidden as an unflattering one. Never write a sentence like \"maintained a calm demeanor,\" \"didn't raise their voice,\" \"sounded frustrated,\" \"spoke hesitantly,\" or \"maintained a respectful tone\" — you have no basis for any of them, complimentary or not. Say \"used respectful wording\" or \"used non-escalatory language\" instead of \"respectful tone\" or \"calm tone.\" This overrides anything above: if a principle, common mistake, or evaluation criterion (including Non-escalation) is phrased using a word like \"calm,\" \"tone,\" \"voice,\" or \"demeanor,\" judge it purely by the wording and language choices actually visible in the transcript — for example, non-escalatory phrasing versus hostile, retaliatory, or inflammatory language — never by an assumed vocal delivery. When in doubt, phrase the point in terms of what was said or how it was worded, not how it sounded.",
